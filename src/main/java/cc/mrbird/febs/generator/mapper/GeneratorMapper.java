...
public interface GeneratorMapper {
    ...
    IPage<Table> getTables(@SuppressWarnings("rawtypes") Page page, @Param("tableName") String tableName, @Param("databaseType") String databaseType, @Param("schemaName") String schemaName);
